        ...
        <div class="footer-columns">
            ...
            <div class="footer-col">
                ...
                <div class="icon-row">
                    ...
                    <div class="icon-box">
                        <img src="${pageContext.request.contextPath}/assets/images/Payment/momo.webp" alt="Momo">
                    </div>
                    <div class="icon-box">
                        <img src="${pageContext.request.contextPath}/assets/images/Payment/vnpay.webp" alt="VNPAY">
                    </div>
                </div>
                ...
                <div class="icon-row">
                    <div class="icon-box">
                        <img src="${pageContext.request.contextPath}/assets/images/Transport/ghtk.webp" alt="GHTK">
                    </div>
                    <div class="icon-box">
                        <img src="${pageContext.request.contextPath}/assets/images/Transport/ghn.png" alt="GHN">
                    </div>
                    <div class="icon-box">
                        <img src="${pageContext.request.contextPath}/assets/images/Transport/jnt.webp" alt="J&T">
                    </div>
                </div>
            </div>
